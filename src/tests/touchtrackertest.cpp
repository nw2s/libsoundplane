...
/* Test program by M Harris / Technobear */
...
namespace 
{
	...
	class TouchTrackerTest : public SoundplaneDriverListener
	{
		...
		public:
		    ...
		    TouchTrackerTest() :  mTracker(kSoundplaneWidth,kSoundplaneHeight), mSurface(kSoundplaneWidth, kSoundplaneHeight), mCalibration(kSoundplaneWidth, kSoundplaneHeight), mTest(kSoundplaneWidth, kSoundplaneHeight)
		    {
